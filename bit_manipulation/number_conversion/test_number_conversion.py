import pytest
from bit_manipulation.number_conversion.number_conversion import NumberConversion
from bit_manipulation.number_conversion.solution import NumberConversionSolution
