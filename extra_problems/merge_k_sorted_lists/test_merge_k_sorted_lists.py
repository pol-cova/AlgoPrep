...
from extra_problems.merge_k_sorted_lists.merge_k_sorted_lists import MergeKSortedLists
from extra_problems.merge_k_sorted_lists.solution import MergeKSortedListsSolution
